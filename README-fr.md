# Per Aspera Mod Launcher — Documentation française
...
**Installer BepInEx** → **▶ JOUER** une fois (génération de l'interop, 1-3 min, le launcher surveille) → **Installer / MAJ le SDK** → Installer vos mods → **▶ JOUER**

## Fonctionnement

- Les mods installés sont suivis dans `%AppData%\PerAsperaLauncher\` (manifest des fichiers posés par mod → désinstallation propre)
